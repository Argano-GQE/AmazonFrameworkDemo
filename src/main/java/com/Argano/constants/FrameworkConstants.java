...
public final class FrameworkConstants {
	...
	private static final String EDGEDRIVERPATH = RESOURCESPATH + "/browserExecutables/msedgedriver.exe";
	private static final String FIREFOXDRIVERPATH = RESOURCESPATH + "/browserExecutables/geckodriver.exe";
	
	private static final String APPLICATIONNAME = "AMAZON ";
